...
class GraphTextDataset(Dataset):
    ...
    def process(self):
        ...
        for raw_path in self.raw_paths:
            ...
            raw_path=raw_path[:-6]+"0.graph"
            edge_index0, x0 = self.process_graph(raw_path)
            raw_path=raw_path[:-7]+"1.graph"
            edge_index1, x1 = self.process_graph(raw_path)
            raw_path=raw_path[:-7]+"2.graph"
            edge_index2, x2 = self.process_graph(raw_path)
            data = Data(x=x0, edge_index=edge_index0,
                        x1=x1, edge_index1=edge_index1,
                        x2=x2, edge_index2=edge_index2,
